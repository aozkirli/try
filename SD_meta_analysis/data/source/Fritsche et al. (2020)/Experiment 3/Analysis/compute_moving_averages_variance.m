...
for iBack = 1:nBack
    ...
    for iSubject = 1:size(sd_data.data_nback{iBack},1)
        ...
        if cfg.demean == true
            ...
            moving_averages_short{iBack}{iSubject} = ...
                moving_averages_short{iBack}{iSubject} - ...
                mean(moving_averages_short{iBack}{iSubject});
        ...
        if cfg.demean == true
            ...
            moving_averages_long{iBack}{iSubject} = ...
                moving_averages_long{iBack}{iSubject} - ...
                mean(moving_averages_long{iBack}{iSubject});
